...
1. **Create a Free Account**: To create your free CrateBytes account, visit the [CrateBytes login page](https://cloud.cratebytes.com/login).
2. **Create a New Project**: Once you've logged in, create you'll be prompted to create a new project.
